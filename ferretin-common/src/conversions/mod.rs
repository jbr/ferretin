...
pub fn load_and_normalize(json: &[u8]) -> Result<Crate> {
    ...
    let version_check: serde_json::Value = serde_json::from_slice(json)
    ...
    match format_version {
        ...
        56 => {
            ...
            let crate_56: rustdoc_types_56::Crate = serde_json::from_slice(json)
                .context("Failed to parse as format version 56")?;
            v56::convert_crate(crate_56)
        }
        55 => {
            // Parse as v55, convert to v56, then to v57
            let crate_55: rustdoc_types_55::Crate = serde_json::from_slice(json)
                .context("Failed to parse as format version 55")?;
            let crate_56 = v55::convert_crate(crate_55)
                .context("Failed to convert v55 to v56")?;
            v56::convert_crate(crate_56)
        }
        v if v < 55 => {
            anyhow::bail!(
